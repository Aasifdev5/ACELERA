            ...
            <div class="card mt-4 p-4">
               ...
               <form action="{{ url('admin/update_course') }}" enctype="multipart/form-data" id="startCampaignForm" class=" theme-form form-horizontal" method="post">
                ...
                <div class="form-group">
                    <label for="approval_status" class="col-sm-4 control-label">Approval Status <span class="field-required">*</span></label>
                    <div class="col-sm-8">
                        <select class="form-control select2" name="status">
                            <option value="">Select Approval Status</option>
                            <option value="0" {{ $project_detail->status == '0' ? 'selected' : '' }}>Pending</option>
                            <option value="1" {{ $project_detail->status == '1' ? 'selected' : '' }}>Approved</option>
                            <option value="-1" {{ $project_detail->status == '-1' ? 'selected' : '' }}>Blocked</option>
                        </select>
