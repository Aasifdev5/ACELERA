                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="text" name="country_name" class="form-control" id="country_name" placeholder="{{ __('Type country name') }}" value="{{ old('country_name') }}" required>
                            ...
                            <div class="col-6">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="text" name="short_name" class="form-control" id="short_name" placeholder="{{ __('Type short name') }}" value="{{ old('short_name') }}" required>
                            ...
                            <div class="col-6">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="text" name="phonecode" class="form-control" id="phonecode" placeholder="{{ __('Type phone code') }}" value="{{ old('phonecode') }}" required>
                            ...
                            <div class="col-6">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="text" name="continent" class="form-control" id="continent" placeholder="{{ __('Type continent') }}" value="{{ old('continent') }}" required>
